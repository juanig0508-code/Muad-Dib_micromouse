...
#define DATA_LENGTH (2 + NUM_SENSORES + MAZE_CELLS + MENU_RUN_NUM_MODES + RC5_DATA_LENGTH + RC5_MAPPINGS_DATA_LENGTH)
...
#define DATA_INDEX_RC5_MAPPINGS (DATA_INDEX_RC5 + RC5_DATA_LENGTH)
